...
class Kernel(Configurable):
    ...
    def do_one_iteration(self):
        ...
        if handler is None:
            self._logger.error("UNKNOWN MESSAGE TYPE:", msg)
        else:
            handler(ident, msg)
    ...
    def execute_request(self, ident, parent):
        ...
        try:
            ...
            self._logger.error("Got bad msg: " +Message(parent))
            return
    ...
    def complete_request(self, ident, parent):
        ...
        self._logger.debug(completion_msg)
    ...
    def _raw_input(self, prompt, ident, parent):
        ...
        try:
            ...
            self._logger.error("Got bad raw_input reply: "+Message(parent));
            value = ''
        return value
    ...
    def _at_shutdown(self):
        ...
        if self._shutdown_message is not None:
            ...
            self._logger.debug(self._shutdown_message)
